...
Процедура ПроизвестиОбновлениеИнформационнойБазы(ИнформационнаяБаза)
	...
	Для каждого Версия Из МассивВерсий Цикл
		...
		ПодключитьОбработчикОжидания("Подключаемый_ПроверитьУспешностьВыполненияОперации", 30);
...
Процедура Подключаемый_ПроверитьУспешностьВыполненияОперации() Экспорт 
